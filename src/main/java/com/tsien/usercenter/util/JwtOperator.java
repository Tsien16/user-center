package com.tsien.usercenter.util;
...
//        // 会生成类似该字符串的内容: eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE2MDA2ODc4NzIsImV4cCI6MTYwMTg5NzQ3Mn0
//        // .6ndrLRq2NVeJey9eOFBPxJ1u4d5CyHKNCsr6t5OMVVU
//        System.out.println(token);
//
//        // 将我改成上面生成的token!!!
//        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE2MDA2ODc4NzIsImV4cCI6MTYwMTg5NzQ3Mn0" +
//                ".6ndrLRq2NVeJey9eOFBPxJ1u4d5CyHKNCsr6t5OMVVU";
...
//        String encodedPayload = "eyJpZCI6IjEiLCJpYXQiOjE2MDA2ODc4NzIsImV4cCI6MTYwMTg5NzQ3Mn0";
//        // 测试5: 解密Payload
//        byte[] payload = Base64.decodeBase64(encodedPayload.getBytes());
//        System.out.println(new String(payload));
//
//        // 测试6: 这是一个被篡改的token，因此会报异常，说明JWT是安全的
//        jwtOperator.validateToken("ayJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE2MDA2ODc4NzIsImV4cCI6MTYwMTg5NzQ3Mn0" +
//                ".6ndrLRq2NVeJey9eOFBPxJ1u4d5CyHKNCsr6t5OMVVU");
//    }
}
